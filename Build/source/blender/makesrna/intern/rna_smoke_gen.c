...
BoolPropertyRNA rna_SmokeDomainSettings_display_velocity;
...
bool SmokeDomainSettings_display_velocity_get(PointerRNA *ptr)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
	return (bool)(data->draw_velocity);
}

void SmokeDomainSettings_display_velocity_set(PointerRNA *ptr, bool value)
{
	SmokeDomainSettings *data = (SmokeDomainSettings *)(ptr->data);
...
EnumPropertyRNA rna_SmokeDomainSettings_display_interpolation = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_display_velocity, (PropertyRNA *)&rna_SmokeDomainSettings_display_thickness,
...
BoolPropertyRNA rna_SmokeDomainSettings_display_velocity = {
	...
	-1, "display_velocity", 3, 0, 0, 4, 0, "Display Velocity",
	"Toggle visualization of the velocity field as needles",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 85393408, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(SmokeDomainSettings, draw_velocity), 2, NULL},
	SmokeDomainSettings_display_velocity_get, SmokeDomainSettings_display_velocity_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};
...
EnumPropertyRNA rna_SmokeDomainSettings_vector_display_type = {
	{(PropertyRNA *)&rna_SmokeDomainSettings_vector_scale, (PropertyRNA *)&rna_SmokeDomainSettings_display_velocity,
...
static const EnumPropertyItem rna_SmokeFlowSettings_smoke_flow_source_items[3] = {
	{0, "PARTICLES", 160, "Particle System", "Emit smoke from particles"},
	{1, "MESH", 571, "Mesh", "Emit smoke from mesh surface or volume"},
	{0, NULL, 0, NULL, NULL}
};
