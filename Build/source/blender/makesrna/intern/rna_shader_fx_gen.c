...
BoolPropertyRNA rna_ShaderFxSwirl_transparent;
...
bool ShaderFxSwirl_transparent_get(PointerRNA *ptr)
{
	SwirlShaderFxData *data = (SwirlShaderFxData *)(ptr->data);
	return (((data->flag) & 1) != 0);
}

void ShaderFxSwirl_transparent_set(PointerRNA *ptr, bool value)
{
	SwirlShaderFxData *data = (SwirlShaderFxData *)(ptr->data);
	if (value) data->flag |= 1;
	else data->flag &= ~1;
...
FloatPropertyRNA rna_ShaderFxSwirl_angle = {
	{(PropertyRNA *)&rna_ShaderFxSwirl_transparent, (PropertyRNA *)&rna_ShaderFxSwirl_radius,
...
BoolPropertyRNA rna_ShaderFxSwirl_transparent = {
	...
	-1, "transparent", 3, 0, 0, 0, 0, "Transparent",
	"Make image transparent outside of radius",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_ShaderFx_update, 85458944, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	ShaderFxSwirl_transparent_get, ShaderFxSwirl_transparent_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

PointerPropertyRNA rna_ShaderFxSwirl_object = {
	{NULL, (PropertyRNA *)&rna_ShaderFxSwirl_transparent,
	-1, "object", 9437313, 0, 0, 0, 0, "Object",
