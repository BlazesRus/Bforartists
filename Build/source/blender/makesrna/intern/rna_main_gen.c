...
int BlendData_cameras_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_camera_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_scenes_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_scene_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_objects_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_object_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_materials_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_mat_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_node_groups_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_nodetree_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_meshes_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_mesh_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_lights_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_light_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_libraries_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_library_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_screens_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_screen_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_window_managers_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_wm_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_images_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_image_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_lattices_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_latt_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_curves_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_curve_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_metaballs_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_mball_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_fonts_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_font_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_textures_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_tex_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_brushes_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_brush_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_worlds_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_world_lookup_string(ptr, key, r_ptr);
}
...
void BlendData_collections_begin(CollectionPropertyIterator *iter, PointerRNA *ptr)
{
	...
	rna_Main_collection_begin(iter, ptr);
...
int BlendData_collections_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_collection_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_shape_keys_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_key_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_texts_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_text_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_speakers_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_speaker_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_sounds_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_sound_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_armatures_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_armature_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_actions_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_action_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_particles_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_particle_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_palettes_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_palette_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_grease_pencil_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_gpencil_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_movieclips_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_movieclip_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_masks_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_mask_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_linestyles_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_linestyle_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_cache_files_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_cachefile_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_paint_curves_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_paintcurve_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_workspaces_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_workspace_lookup_string(ptr, key, r_ptr);
}
...
int BlendData_lightprobes_lookup_string(PointerRNA *ptr, const char *key, PointerRNA *r_ptr)
{
	return rna_Main_lightprobe_lookup_string(ptr, key, r_ptr);
}
...
struct Lamp *BlendDataLights_new(struct Main *_self, const char * name, int type)
{
...
struct Lamp *rna_Main_lights_new(struct Main *_self, const char * name, int type);
...
CollectionPropertyRNA rna_BlendData_cameras = {
	...
	BlendData_cameras_begin, BlendData_cameras_next, BlendData_cameras_end, BlendData_cameras_get, NULL, NULL, BlendData_cameras_lookup_string, NULL, &RNA_Camera
};
...
CollectionPropertyRNA rna_BlendData_scenes = {
	...
	BlendData_scenes_begin, BlendData_scenes_next, BlendData_scenes_end, BlendData_scenes_get, NULL, NULL, BlendData_scenes_lookup_string, NULL, &RNA_Scene
};
...
CollectionPropertyRNA rna_BlendData_objects = {
	...
	BlendData_objects_begin, BlendData_objects_next, BlendData_objects_end, BlendData_objects_get, NULL, NULL, BlendData_objects_lookup_string, NULL, &RNA_Object
};
...
CollectionPropertyRNA rna_BlendData_materials = {
	...
	BlendData_materials_begin, BlendData_materials_next, BlendData_materials_end, BlendData_materials_get, NULL, NULL, BlendData_materials_lookup_string, NULL, &RNA_Material
};
...
CollectionPropertyRNA rna_BlendData_node_groups = {
	...
	BlendData_node_groups_begin, BlendData_node_groups_next, BlendData_node_groups_end, BlendData_node_groups_get, NULL, NULL, BlendData_node_groups_lookup_string, NULL, &RNA_NodeTree
};
...
CollectionPropertyRNA rna_BlendData_meshes = {
	...
	BlendData_meshes_begin, BlendData_meshes_next, BlendData_meshes_end, BlendData_meshes_get, NULL, NULL, BlendData_meshes_lookup_string, NULL, &RNA_Mesh
};
...
CollectionPropertyRNA rna_BlendData_lights = {
	...
	BlendData_lights_begin, BlendData_lights_next, BlendData_lights_end, BlendData_lights_get, NULL, NULL, BlendData_lights_lookup_string, NULL, &RNA_Light
};
...
CollectionPropertyRNA rna_BlendData_libraries = {
	...
	BlendData_libraries_begin, BlendData_libraries_next, BlendData_libraries_end, BlendData_libraries_get, NULL, NULL, BlendData_libraries_lookup_string, NULL, &RNA_Library
};
...
CollectionPropertyRNA rna_BlendData_screens = {
	...
	BlendData_screens_begin, BlendData_screens_next, BlendData_screens_end, BlendData_screens_get, NULL, NULL, BlendData_screens_lookup_string, NULL, &RNA_Screen
};
...
CollectionPropertyRNA rna_BlendData_window_managers = {
	...
	BlendData_window_managers_begin, BlendData_window_managers_next, BlendData_window_managers_end, BlendData_window_managers_get, NULL, NULL, BlendData_window_managers_lookup_string, NULL, &RNA_WindowManager
};
...
CollectionPropertyRNA rna_BlendData_images = {
	...
	BlendData_images_begin, BlendData_images_next, BlendData_images_end, BlendData_images_get, NULL, NULL, BlendData_images_lookup_string, NULL, &RNA_Image
};
...
CollectionPropertyRNA rna_BlendData_lattices = {
	...
	BlendData_lattices_begin, BlendData_lattices_next, BlendData_lattices_end, BlendData_lattices_get, NULL, NULL, BlendData_lattices_lookup_string, NULL, &RNA_Lattice
};
...
CollectionPropertyRNA rna_BlendData_curves = {
	...
	BlendData_curves_begin, BlendData_curves_next, BlendData_curves_end, BlendData_curves_get, NULL, NULL, BlendData_curves_lookup_string, NULL, &RNA_Curve
};
...
CollectionPropertyRNA rna_BlendData_metaballs = {
	...
	BlendData_metaballs_begin, BlendData_metaballs_next, BlendData_metaballs_end, BlendData_metaballs_get, NULL, NULL, BlendData_metaballs_lookup_string, NULL, &RNA_MetaBall
};
...
CollectionPropertyRNA rna_BlendData_fonts = {
	...
	BlendData_fonts_begin, BlendData_fonts_next, BlendData_fonts_end, BlendData_fonts_get, NULL, NULL, BlendData_fonts_lookup_string, NULL, &RNA_VectorFont
};
...
CollectionPropertyRNA rna_BlendData_textures = {
	...
	BlendData_textures_begin, BlendData_textures_next, BlendData_textures_end, BlendData_textures_get, NULL, NULL, BlendData_textures_lookup_string, NULL, &RNA_Texture
};
...
CollectionPropertyRNA rna_BlendData_brushes = {
	...
	BlendData_brushes_begin, BlendData_brushes_next, BlendData_brushes_end, BlendData_brushes_get, NULL, NULL, BlendData_brushes_lookup_string, NULL, &RNA_Brush
};
...
CollectionPropertyRNA rna_BlendData_worlds = {
	...
	BlendData_worlds_begin, BlendData_worlds_next, BlendData_worlds_end, BlendData_worlds_get, NULL, NULL, BlendData_worlds_lookup_string, NULL, &RNA_World
};
...
CollectionPropertyRNA rna_BlendData_collections = {
	...
	BlendData_collections_begin, BlendData_collections_next, BlendData_collections_end, BlendData_collections_get, NULL, NULL, BlendData_collections_lookup_string, NULL, &RNA_Collection
};
...
CollectionPropertyRNA rna_BlendData_shape_keys = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	BlendData_shape_keys_begin, BlendData_shape_keys_next, BlendData_shape_keys_end, BlendData_shape_keys_get, NULL, NULL, BlendData_shape_keys_lookup_string, NULL, &RNA_Key
};
...
CollectionPropertyRNA rna_BlendData_texts = {
	...
	BlendData_texts_begin, BlendData_texts_next, BlendData_texts_end, BlendData_texts_get, NULL, NULL, BlendData_texts_lookup_string, NULL, &RNA_Text
};
...
CollectionPropertyRNA rna_BlendData_speakers = {
	...
	BlendData_speakers_begin, BlendData_speakers_next, BlendData_speakers_end, BlendData_speakers_get, NULL, NULL, BlendData_speakers_lookup_string, NULL, &RNA_Speaker
};
...
CollectionPropertyRNA rna_BlendData_sounds = {
	...
	BlendData_sounds_begin, BlendData_sounds_next, BlendData_sounds_end, BlendData_sounds_get, NULL, NULL, BlendData_sounds_lookup_string, NULL, &RNA_Sound
};
...
CollectionPropertyRNA rna_BlendData_armatures = {
	...
	BlendData_armatures_begin, BlendData_armatures_next, BlendData_armatures_end, BlendData_armatures_get, NULL, NULL, BlendData_armatures_lookup_string, NULL, &RNA_Armature
};
...
CollectionPropertyRNA rna_BlendData_actions = {
	...
	BlendData_actions_begin, BlendData_actions_next, BlendData_actions_end, BlendData_actions_get, NULL, NULL, BlendData_actions_lookup_string, NULL, &RNA_Action
};
...
CollectionPropertyRNA rna_BlendData_particles = {
	...
	BlendData_particles_begin, BlendData_particles_next, BlendData_particles_end, BlendData_particles_get, NULL, NULL, BlendData_particles_lookup_string, NULL, &RNA_ParticleSettings
};
...
CollectionPropertyRNA rna_BlendData_palettes = {
	...
	BlendData_palettes_begin, BlendData_palettes_next, BlendData_palettes_end, BlendData_palettes_get, NULL, NULL, BlendData_palettes_lookup_string, NULL, &RNA_Palette
};

CollectionPropertyRNA rna_BlendData_grease_pencil = {
	{(PropertyRNA *)&rna_BlendData_movieclips, (PropertyRNA *)&rna_BlendData_palettes,
	-1, "grease_pencil", 128, 0, 0, 0, 0, "Grease Pencil",
	"Grease Pencil data-blocks",
	0, "*",
	PROP_COLLECTION, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, &RNA_BlendDataGreasePencils},
	BlendData_grease_pencil_begin, BlendData_grease_pencil_next, BlendData_grease_pencil_end, BlendData_grease_pencil_get, NULL, NULL, BlendData_grease_pencil_lookup_string, NULL, &RNA_GreasePencil
};
...
CollectionPropertyRNA rna_BlendData_movieclips = {
	...
	BlendData_movieclips_begin, BlendData_movieclips_next, BlendData_movieclips_end, BlendData_movieclips_get, NULL, NULL, BlendData_movieclips_lookup_string, NULL, &RNA_MovieClip
};
...
CollectionPropertyRNA rna_BlendData_masks = {
	...
	BlendData_masks_begin, BlendData_masks_next, BlendData_masks_end, BlendData_masks_get, NULL, NULL, BlendData_masks_lookup_string, NULL, &RNA_Mask
};
...
CollectionPropertyRNA rna_BlendData_linestyles = {
	...
	BlendData_linestyles_begin, BlendData_linestyles_next, BlendData_linestyles_end, BlendData_linestyles_get, NULL, NULL, BlendData_linestyles_lookup_string, NULL, &RNA_FreestyleLineStyle
};
...
CollectionPropertyRNA rna_BlendData_cache_files = {
	...
	BlendData_cache_files_begin, BlendData_cache_files_next, BlendData_cache_files_end, BlendData_cache_files_get, NULL, NULL, BlendData_cache_files_lookup_string, NULL, &RNA_CacheFile
};
...
CollectionPropertyRNA rna_BlendData_paint_curves = {
	...
	BlendData_paint_curves_begin, BlendData_paint_curves_next, BlendData_paint_curves_end, BlendData_paint_curves_get, NULL, NULL, BlendData_paint_curves_lookup_string, NULL, &RNA_PaintCurve
};
...
CollectionPropertyRNA rna_BlendData_workspaces = {
	...
	BlendData_workspaces_begin, BlendData_workspaces_next, BlendData_workspaces_end, BlendData_workspaces_get, NULL, NULL, BlendData_workspaces_lookup_string, NULL, &RNA_WorkSpace
};
...
CollectionPropertyRNA rna_BlendData_lightprobes = {
	...
	BlendData_lightprobes_begin, BlendData_lightprobes_next, BlendData_lightprobes_end, BlendData_lightprobes_get, NULL, NULL, BlendData_lightprobes_lookup_string, NULL, &RNA_LightProbe
};
...
static const EnumPropertyItem rna_BlendDataTextures_new_type_items[13] = {
	{0, "NONE", 0, "None", ""},
	{5, "BLEND", 152, "Blend", "Procedural - create a ramp texture"},
	{1, "CLOUDS", 152, "Clouds", "Procedural - create a cloud-like fractal noise texture"},
	{13, "DISTORTED_NOISE", 152, "Distorted Noise", "Procedural - noise texture distorted by two noise algorithms"},
	{8, "IMAGE", 351, "Image or Movie", "Allow for images or movies to be used as textures"},
	{4, "MAGIC", 152, "Magic", "Procedural - color texture based on trigonometric functions"},
	{3, "MARBLE", 152, "Marble", "Procedural - marble-like noise texture with wave generated bands"},
	{11, "MUSGRAVE", 152, "Musgrave", "Procedural - highly flexible fractal noise texture"},
	{7, "NOISE", 152, "Noise", "Procedural - random noise, gives a different result every time, for every frame, for every pixel"},
	{6, "STUCCI", 152, "Stucci", "Procedural - create a fractal noise texture"},
	{12, "VORONOI", 152, "Voronoi", "Procedural - create cell-like patterns based on Worley noise"},
	{2, "WOOD", 152, "Wood", "Procedural - wave generated bands or rings, with optional noise"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_BlendDataBrushes_new_mode_items[13] = {
	{0, "OBJECT", 250, "Object Mode", ""},
	{1, "EDIT", 251, "Edit Mode", ""},
	{64, "POSE", 257, "Pose Mode", ""},
	{2, "SCULPT", 256, "Sculpt Mode", ""},
	{4, "VERTEX_PAINT", 253, "Vertex Paint", ""},
	{8, "WEIGHT_PAINT", 255, "Weight Paint", ""},
	{16, "TEXTURE_PAINT", 254, "Texture Paint", ""},
	{32, "PARTICLE_EDIT", 258, "Particle Edit", ""},
	{128, "EDIT_GPENCIL", 251, "Edit Mode", "Edit Grease Pencil Strokes"},
	{512, "SCULPT_GPENCIL", 256, "Sculpt Mode", "Sculpt Grease Pencil Strokes"},
	{256, "PAINT_GPENCIL", 365, "Draw", "Paint Grease Pencil Strokes"},
	{1024, "WEIGHT_GPENCIL", 255, "Weight Paint", "Grease Pencil Weight Paint Strokes"},
	{0, NULL, 0, NULL, NULL}
};
