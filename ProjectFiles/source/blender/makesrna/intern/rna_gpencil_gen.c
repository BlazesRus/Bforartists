...
EnumPropertyRNA rna_GreasePencil_xray_mode;
...
BoolPropertyRNA rna_GreasePencil_show_constant_thickness;
...
int GreasePencil_xray_mode_get(PointerRNA *ptr)
{
	bGPdata *data = (bGPdata *)(ptr->data);
	return (int)(data->xray_mode);
}

void GreasePencil_xray_mode_set(PointerRNA *ptr, int value)
{
	bGPdata *data = (bGPdata *)(ptr->data);
	data->xray_mode = value;
}
...
bool GreasePencil_show_constant_thickness_get(PointerRNA *ptr)
{
	bGPdata *data = (bGPdata *)(ptr->data);
	return (((data->flag) & 32768) != 0);
}

void GreasePencil_show_constant_thickness_set(PointerRNA *ptr, bool value)
{
	bGPdata *data = (bGPdata *)(ptr->data);
...
CollectionPropertyRNA rna_GreasePencil_materials = {
	{(PropertyRNA *)&rna_GreasePencil_xray_mode, (PropertyRNA *)&rna_GreasePencil_animation_data,
...
static const EnumPropertyItem rna_GreasePencil_xray_mode_items[4] = {
	{0, "FRONT", 0, "Front", "Draw all strokes in front"},
	{1, "3DSPACE", 0, "3D Space", "Draw strokes relative to other objects in 3D space"},
	{2, "BACK", 0, "Back", "Draw all strokes last"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_GreasePencil_xray_mode = {
	{(PropertyRNA *)&rna_GreasePencil_use_stroke_edit_mode, (PropertyRNA *)&rna_GreasePencil_materials,
	-1, "xray_mode", 3, 0, 0, 0, 0, "X-Ray",
	"",
	0, "*",
	...
	0, -1, NULL},
	GreasePencil_xray_mode_get, GreasePencil_xray_mode_set, NULL, NULL, NULL, NULL, rna_GreasePencil_xray_mode_items, 3, 0
};

BoolPropertyRNA rna_GreasePencil_use_stroke_edit_mode = {
	{(PropertyRNA *)&rna_GreasePencil_is_stroke_paint_mode, (PropertyRNA *)&rna_GreasePencil_xray_mode,
...
BoolPropertyRNA rna_GreasePencil_show_stroke_direction = {
	{(PropertyRNA *)&rna_GreasePencil_show_constant_thickness, (PropertyRNA *)&rna_GreasePencil_use_onion_skinning,
...
BoolPropertyRNA rna_GreasePencil_show_constant_thickness = {
	...
	-1, "show_constant_thickness", 3, 0, 0, 0, 0, "Keep Thickness",
	"Maintain the thickness of the stroke when the viewport zoom changes",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_GPencil_update, 375062528, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	GreasePencil_show_constant_thickness_get, GreasePencil_show_constant_thickness_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_GreasePencil_pixel_factor = {
	{(PropertyRNA *)&rna_GreasePencil_use_multiedit, (PropertyRNA *)&rna_GreasePencil_show_constant_thickness,
...
FloatPropertyRNA rna_GPencilLayer_color = {
	{(PropertyRNA *)&rna_GPencilLayer_thickness, (PropertyRNA *)&rna_GPencilLayer_opacity,
...
BoolPropertyRNA rna_GPencilLayer_use_annotation_onion_skinning = {
	...
	-1, "use_annotation_onion_skinning", 3, 0, 0, 0, 0, "Onion Skinning",
...
IntPropertyRNA rna_GPencilLayer_annotation_onion_before_range = {
	...
	-1, "annotation_onion_before_range", 3, 0, 0, 4, 0, "Frames Before",
...
IntPropertyRNA rna_GPencilLayer_annotation_onion_after_range = {
	...
	-1, "annotation_onion_after_range", 3, 0, 0, 4, 0, "Frames After",
...
FloatPropertyRNA rna_GPencilLayer_annotation_onion_before_color = {
	...
	-1, "annotation_onion_before_color", 3, 0, 0, 4, 0, "Before Color",
	"Base color for ghosts before the active frame",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_GPencil_update, 375062528, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
FloatPropertyRNA rna_GPencilLayer_annotation_onion_after_color = {
	...
	-1, "annotation_onion_after_color", 3, 0, 0, 4, 0, "After Color",
	"Base color for ghosts after the active frame",
	0, "*",
	PROP_FLOAT, PROP_COLOR_GAMMA | PROP_UNIT_NONE, NULL, 1, {3, 0, 0}, 3,
	rna_GPencil_update, 375062528, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
BoolPropertyRNA rna_GPencilLayer_hide = {
	{(PropertyRNA *)&rna_GPencilLayer_lock, (PropertyRNA *)&rna_GPencilLayer_blend_mode,
...
BoolPropertyRNA rna_GPencilLayer_lock_frame = {
	...
	-1, "lock_frame", 4099, 0, 0, 0, 0, "Frame Locked",
