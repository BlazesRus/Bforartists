...
BoolPropertyRNA rna_SubsurfModifier_show_only_control_edges = {
	{NULL, (PropertyRNA *)&rna_SubsurfModifier_render_levels,
...
StructRNA RNA_SubsurfModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_SubsurfModifier_uv_smooth, (PropertyRNA *)&rna_SubsurfModifier_show_only_control_edges}},
...
static const EnumPropertyItem rna_HookModifier_falloff_type_items[10] = {
	{0, "NONE", 0, "No Falloff", ""},
	{1, "CURVE", 0, "Curve", ""},
	{3, "SMOOTH", 1062, "Smooth", ""},
	{7, "SPHERE", 1063, "Sphere", ""},
	{4, "ROOT", 1064, "Root", ""},
	{8, "INVERSE_SQUARE", 1064, "Inverse Square", ""},
	{2, "SHARP", 1065, "Sharp", ""},
	{5, "LINEAR", 1066, "Linear", ""},
	{6, "CONSTANT", 1067, "Constant", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_BevelModifier_edge_weight_method = {
	...
	-1, "edge_weight_method", 3, 0, 0, 0, 0, "Edge Weight Method",
...
BoolPropertyRNA rna_MultiresModifier_show_only_control_edges = {
	{NULL, (PropertyRNA *)&rna_MultiresModifier_filepath,
	-1, "show_only_control_edges", 3, 0, 0, 0, 0, "Optimal Display",
	"Skip drawing/rendering of interior subdivided edges",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StructRNA RNA_MultiresModifier = {
	...
	NULL,
	{(PropertyRNA *)&rna_MultiresModifier_uv_smooth, (PropertyRNA *)&rna_MultiresModifier_show_only_control_edges}},
...
static const EnumPropertyItem rna_VertexWeightEditModifier_falloff_type_items[9] = {
	{0, "LINEAR", 1066, "Linear", "Null action"},
	{1, "CURVE", 1068, "Custom Curve", ""},
	{2, "SHARP", 1065, "Sharp", ""},
	{3, "SMOOTH", 1062, "Smooth", ""},
	{4, "ROOT", 1064, "Root", ""},
	{7, "ICON_SPHERECURVE", 1063, "Sphere", ""},
	{8, "RANDOM", 1068, "Random", ""},
	{9, "STEP", 1067, "Median Step", "Map all values below 0.5 to 0.0, and all others to 1.0"},
	{0, NULL, 0, NULL, NULL}
};
