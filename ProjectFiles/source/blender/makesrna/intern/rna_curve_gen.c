...
static const EnumPropertyItem rna_TextCurve_align_x_items[6] = {
	{0, "LEFT", 192, "Left", "Align text to the left"},
	{1, "CENTER", 149, "Center", "Center text"},
	{2, "RIGHT", 194, "Right", "Align text to the right"},
	{3, "JUSTIFY", 191, "Justify", "Align to the left and the right"},
	{4, "FLUSH", 190, "Flush", "Align to the left and the right, with equal character spacing"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_TextCurve_align_y_items[6] = {
	{0, "TOP_BASELINE", 196, "Top Base-Line", "Align to top but use the base-line of the text"},
	{1, "TOP", 196, "Top", "Align text to the top"},
	{2, "CENTER", 193, "Center", "Align text to the middle"},
	{4, "BOTTOM", 195, "Bottom", "Align text to the bottom"},
	{3, "BOTTOM_BASELINE", 195, "Bottom Base-Line", "Align text to the bottom but use the base-line of the text"},
	{0, NULL, 0, NULL, NULL}
};
