...
EnumPropertyRNA rna_Armature_display_type = {
	{(PropertyRNA *)&rna_Armature_ghost_type, (PropertyRNA *)&rna_Armature_pose_position,
...
EnumPropertyRNA rna_Armature_ghost_type = {
	{(PropertyRNA *)&rna_Armature_layers, (PropertyRNA *)&rna_Armature_display_type,
	-1, "ghost_type", 65539, 0, 0, 0, 0, "Ghost Type",
...
BoolPropertyRNA rna_Armature_show_only_ghost_selected = {
	...
	-1, "show_only_ghost_selected", 65539, 0, 0, 0, 0, "Display Ghosts on Selected Bones Only",
	"",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Armature_redraw_data, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
IntPropertyRNA rna_Armature_ghost_step = {
	...
	-1, "ghost_step", 65539, 0, 0, 4, 0, "Ghosting Step",
...
IntPropertyRNA rna_Armature_ghost_size = {
	...
	-1, "ghost_size", 65539, 0, 0, 4, 0, "Ghosting Frame Step",
...
IntPropertyRNA rna_Armature_ghost_frame_start = {
	...
	-1, "ghost_frame_start", 65539, 0, 0, 0, 0, "Ghosting Start Frame",
...
IntPropertyRNA rna_Armature_ghost_frame_end = {
	...
	-1, "ghost_frame_end", 65539, 0, 0, 0, 0, "Ghosting End Frame",
