...
static const EnumPropertyItem rna_FCurveModifiers_new_type_items[9] = {
	{0, "NULL", 0, "Invalid", ""},
	{1, "GENERATOR", 383, "Generator", "Generate a curve using a factorized or expanded polynomial"},
	{2, "FNGENERATOR", 380, "Built-In Function", "Generate a curve using standard math functions such as sin and cos"},
	{3, "ENVELOPE", 382, "Envelope", "Reshape F-Curve values - e.g. change amplitude of movements"},
	{4, "CYCLES", 381, "Cycles", "Cyclic extend/repeat keyframe sequence"},
	{5, "NOISE", 385, "Noise", "Add pseudo-random noise on top of F-Curves"},
	{8, "LIMITS", 384, "Limits", "Restrict maximum and minimum values of F-Curve"},
	{9, "STEPPED", 386, "Stepped Interpolation", "Snap values to nearest grid-step - e.g. for a stop-motion look"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_DriverVariable_type_items[5] = {
	{0, "SINGLE_PROP", 374, "Single Property", "Use the value from some RNA property (Default)"},
	{3, "TRANSFORMS", 749, "Transform Channel", "Final transformation value of object or bone"},
	{1, "ROTATION_DIFF", 748, "Rotational Difference", "Use the angle between two bones"},
	{2, "LOC_DIFF", 747, "Distance", "Distance between two bones or objects"},
	{0, NULL, 0, NULL, NULL}
};
