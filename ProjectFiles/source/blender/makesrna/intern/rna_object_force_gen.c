...
static const EnumPropertyItem rna_FieldSettings_type_items[15] = {
	{0, "NONE", 0, "None", ""},
	{1, "FORCE", 650, "Force", "Radial field toward the center of object"},
	{4, "WIND", 651, "Wind", "Constant force along the force object\'s local Z axis"},
	{2, "VORTEX", 652, "Vortex", "Spiraling force that twists the force object\'s local Z axis"},
	{3, "MAGNET", 653, "Magnetic", "Forcefield depends on the speed of the particles"},
	{7, "HARMONIC", 654, "Harmonic", "The source of this force field is the zero point of a harmonic oscillator"},
	{8, "CHARGE", 655, "Charge", "Spherical forcefield based on the charge of particles, only influences other charge force fields"},
	{9, "LENNARDJ", 656, "Lennard-Jones", "Forcefield based on the Lennard-Jones potential"},
	{6, "TEXTURE", 657, "Texture", "Forcefield based on a texture"},
	{5, "GUIDE", 658, "Curve Guide", "Create a force along a curve object"},
	{10, "BOID", 659, "Boid", ""},
	{11, "TURBULENCE", 660, "Turbulence", "Create turbulence with a noise field"},
	{12, "DRAG", 661, "Drag", "Create a force that dampens motion"},
	{13, "SMOKE_FLOW", 662, "Smoke Flow", "Create a force based on smoke simulation air flow"},
	{0, NULL, 0, NULL, NULL}
};
