...
static const EnumPropertyItem rna_Brush_sculpt_tool_items[23] = {
	{1, "DRAW", 1520, "Draw", ""},
	{8, "CLAY", 1503, "Clay", ""},
	{18, "CLAY_STRIPS", 1504, "Clay Strips", ""},
	{6, "LAYER", 1512, "Layer", ""},
	{4, "INFLATE", 1511, "Inflate", ""},
	{17, "BLOB", 1501, "Blob", ""},
	{16, "CREASE", 1506, "Crease", ""},
	{0, "", 0, NULL, NULL},
	{2, "SMOOTH", 1522, "Smooth", ""},
	{7, "FLATTEN", 1509, "Flatten", ""},
	{9, "FILL", 1508, "Fill", ""},
	{10, "SCRAPE", 1519, "Scrape", ""},
	{3, "PINCH", 1518, "Pinch", ""},
	{0, "", 0, NULL, NULL},
	{5, "GRAB", 1510, "Grab", ""},
	{13, "SNAKE_HOOK", 1523, "Snake Hook", ""},
	{12, "THUMB", 1529, "Thumb", ""},
	{11, "NUDGE", 1517, "Nudge", ""},
	{14, "ROTATE", 1530, "Rotate", ""},
	{0, "", 0, NULL, NULL},
	{19, "MASK", 1514, "Mask", ""},
	{15, "SIMPLIFY", 1525, "Simplify", ""},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_Brush_gpencil_tool_items[4] = {
	{0, "DRAW", 945, "Draw", "The brush is of type used for drawing strokes"},
	{1, "FILL", 102, "Fill", "The brush is of type used for filling areas"},
	{2, "ERASE", 57, "Erase", "The brush is used for erasing strokes"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_Brush_direction_items[3] = {
	{0, "ADD", 147, "Add", "Add effect of brush"},
	{512, "SUBTRACT", 544, "Subtract", "Subtract effect of brush"},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_Brush_use_original_normal = {
	...
	-1, "use_original_normal", 4099, 0, 0, 0, 0, "Original Normal",
...
BoolPropertyRNA rna_Brush_use_space_attenuation = {
	...
	-1, "use_space_attenuation", 4099, 0, 0, 0, 0, "Use Automatic Strength Adjustment",
...
BoolPropertyRNA rna_Brush_use_locked_size = {
	...
	-1, "use_locked_size", 4099, 0, 0, 0, 0, "Use Blender Units",
...
BoolPropertyRNA rna_BrushCapabilitiesSculpt_has_strength_pressure = {
	{(PropertyRNA *)&rna_BrushCapabilitiesSculpt_has_gravity, (PropertyRNA *)&rna_BrushCapabilitiesSculpt_has_space_attenuation,
...
BoolPropertyRNA rna_BrushCapabilitiesSculpt_has_gravity = {
	{NULL, (PropertyRNA *)&rna_BrushCapabilitiesSculpt_has_strength_pressure,
...
IntPropertyRNA rna_BrushGpencilSettings_fill_simplify_level = {
	{(PropertyRNA *)&rna_BrushGpencilSettings_uv_random, (PropertyRNA *)&rna_BrushGpencilSettings_fill_leak,
...
static const EnumPropertyItem rna_BrushGpencilSettings_gp_icon_items[11] = {
	{1, "PENCIL", 1566, "Pencil", ""},
	{2, "PEN", 1567, "Pen", ""},
	{3, "INK", 1568, "Ink", ""},
	{4, "INKNOISE", 1569, "Ink Noise", ""},
	{5, "BLOCK", 1570, "Block", ""},
	{6, "MARKER", 1571, "Marker", ""},
	{7, "FILL", 1573, "Fill", ""},
	{8, "SOFT", 1574, "Eraser Soft", ""},
	{9, "HARD", 1575, "Eraser Hard", ""},
	{10, "STROKE", 1576, "Eraser Stroke", ""},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_BrushGpencilSettings_fill_draw_mode_items[4] = {
	...
	{2, "CONTROL", 0, "Control", "Use internal control lines as fill boundary limits"},
	{0, "BOTH", 0, "Both", "Use visible strokes and control lines as fill boundary limits"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_BrushGpencilSettings_fill_draw_mode = {
	{(PropertyRNA *)&rna_BrushGpencilSettings_material, (PropertyRNA *)&rna_BrushGpencilSettings_eraser_mode,
...
PointerPropertyRNA rna_BrushGpencilSettings_material = {
	{(PropertyRNA *)&rna_BrushGpencilSettings_show_fill_boundary, (PropertyRNA *)&rna_BrushGpencilSettings_fill_draw_mode,
...
BoolPropertyRNA rna_BrushGpencilSettings_use_material_pin = {
	...
	-1, "use_material_pin", 4097, 0, 0, 0, 0, "Pin Material",
