...
BoolPropertyRNA rna_PreferencesView_use_quit_dialog;
IntPropertyRNA rna_PreferencesView_open_left_mouse_delay;
IntPropertyRNA rna_PreferencesView_open_right_mouse_delay;
BoolPropertyRNA rna_PreferencesView_show_column_layout;
BoolPropertyRNA rna_PreferencesView_use_directional_menus;
EnumPropertyRNA rna_PreferencesView_header_align_default;
...
IntPropertyRNA rna_PreferencesInput_tweak_threshold;
...
BoolPropertyRNA rna_PreferencesFilePaths_use_keep_session;
...
BoolPropertyRNA rna_PreferencesSystem_edit_studio_light;
...
{
	bTheme *data = (bTheme *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_ThemePreferences, &data->tuserpref);
}
...
{
	bTheme *data = (bTheme *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_ThemeTopBar, &data->ttopbar);
}

PointerRNA Theme_statusbar_get(PointerRNA *ptr)
{
	bTheme *data = (bTheme *)(ptr->data);
	return rna_pointer_inherit_refine(ptr, &RNA_ThemeStatusBar, &data->tstatusbar);
}
...
bool PreferencesView_use_quit_dialog_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag) & 1073741824) != 0);
}

void PreferencesView_use_quit_dialog_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int PreferencesView_open_left_mouse_delay_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->tb_leftmouse);
}

void PreferencesView_open_left_mouse_delay_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->tb_leftmouse = CLAMPIS(value, 1, 40);
}

int PreferencesView_open_right_mouse_delay_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->tb_rightmouse);
}

void PreferencesView_open_right_mouse_delay_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
int PreferencesView_header_align_default_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return ((data->uiflag) & 128);
}

void PreferencesView_header_align_default_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
	data->uiflag &= ~128;
	data->uiflag |= value;
...
int PreferencesInput_tweak_threshold_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (int)(data->tweak_threshold);
}

void PreferencesInput_tweak_threshold_set(PointerRNA *ptr, int value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool PreferencesFilePaths_use_keep_session_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->uiflag2) & 1) != 0);
}

void PreferencesFilePaths_use_keep_session_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
bool PreferencesSystem_edit_studio_light_get(PointerRNA *ptr)
{
	UserDef *data = (UserDef *)(ptr->data);
	return (((data->edit_studio_light) & 1) != 0);
}

void PreferencesSystem_edit_studio_light_set(PointerRNA *ptr, bool value)
{
	UserDef *data = (UserDef *)(ptr->data);
...
StringPropertyRNA rna_ThemeUserInterface_icon_file = {
	...
	-1, "icon_file", 262145, 0, 0, 0, 0, "Icon File",
	"",
	0, "*",
...
FloatPropertyRNA rna_ThemeUserInterface_icon_alpha = {
	{(PropertyRNA *)&rna_ThemeUserInterface_icon_saturation, (PropertyRNA *)&rna_ThemeUserInterface_icon_file,
...
FloatPropertyRNA rna_ThemeDopeSheet_keyframe_scale_factor = {
	...
	0, "*",
	PROP_FLOAT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 252575744, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
...
static const EnumPropertyItem rna_Theme_theme_area_items[21] = {
	{0, "USER_INTERFACE", 698, "User Interface", ""},
	{19, "STYLE", 1311, "Text Style", ""},
	{18, "BONE_COLOR_SETS", 102, "Bone Color Sets", ""},
	{1, "VIEW_3D", 200, "3D View", ""},
	{3, "GRAPH_EDITOR", 290, "Graph Editor", ""},
	{4, "DOPESHEET_EDITOR", 211, "Dope Sheet", ""},
	{5, "NLA_EDITOR", 212, "Nonlinear Animation", ""},
	{6, "IMAGE_EDITOR", 294, "UV/Image Editor", ""},
	{7, "SEQUENCE_EDITOR", 207, "Video Sequence Editor", ""},
	{8, "TEXT_EDITOR", 208, "Text Editor", ""},
	{9, "NODE_EDITOR", 215, "Node Editor", ""},
	{11, "PROPERTIES", 543, "Properties", ""},
	{12, "OUTLINER", 449, "Outliner", ""},
	{14, "PREFERENCES", 218, "Preferences", ""},
	{15, "INFO", 206, "Info", ""},
	{16, "FILE_BROWSER", 248, "File Browser", ""},
	{17, "CONSOLE", 217, "Python Console", ""},
	{20, "CLIP_EDITOR", 991, "Movie Clip Editor", ""},
	{21, "TOPBAR", 0, "Top Bar", ""},
...
PointerPropertyRNA rna_Theme_console = {
	{(PropertyRNA *)&rna_Theme_bone_color_sets, (PropertyRNA *)&rna_Theme_preferences,
...
PointerPropertyRNA rna_Theme_clip_editor = {
	{(PropertyRNA *)&rna_Theme_topbar, (PropertyRNA *)&rna_Theme_bone_color_sets,
...
PointerPropertyRNA rna_Theme_statusbar = {
	{NULL, (PropertyRNA *)&rna_Theme_topbar,
...
StructRNA RNA_Theme = {
	...
	NULL,
	{(PropertyRNA *)&rna_Theme_rna_properties, (PropertyRNA *)&rna_Theme_statusbar}},
...
BoolPropertyRNA rna_PreferencesView_show_playback_fps = {
	{(PropertyRNA *)&rna_PreferencesView_use_weight_color_range, (PropertyRNA *)&rna_PreferencesView_show_splash,
...
BoolPropertyRNA rna_PreferencesView_use_weight_color_range = {
	{(PropertyRNA *)&rna_PreferencesView_weight_color_range, (PropertyRNA *)&rna_PreferencesView_show_playback_fps,
...
IntPropertyRNA rna_PreferencesView_pie_menu_confirm = {
	{(PropertyRNA *)&rna_PreferencesView_use_quit_dialog, (PropertyRNA *)&rna_PreferencesView_pie_menu_threshold,
...
BoolPropertyRNA rna_PreferencesView_use_quit_dialog = {
	{(PropertyRNA *)&rna_PreferencesView_open_left_mouse_delay, (PropertyRNA *)&rna_PreferencesView_pie_menu_confirm,
	-1, "use_quit_dialog", 3, 0, 0, 0, 0, "Prompt Quit",
	"Ask for confirmation when quitting with unsaved changes",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PreferencesView_use_quit_dialog_get, PreferencesView_use_quit_dialog_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

IntPropertyRNA rna_PreferencesView_open_left_mouse_delay = {
	{(PropertyRNA *)&rna_PreferencesView_open_right_mouse_delay, (PropertyRNA *)&rna_PreferencesView_use_quit_dialog,
	-1, "open_left_mouse_delay", 3, 0, 0, 4, 0, "Hold LMB Open Toolbox Delay",
	"Time in 1/10 seconds to hold the Left Mouse Button before opening the toolbox",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(UserDef, tb_leftmouse), 1, NULL},
	PreferencesView_open_left_mouse_delay_get, PreferencesView_open_left_mouse_delay_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	1, 40, 1, 40, 1, 0, NULL
};

IntPropertyRNA rna_PreferencesView_open_right_mouse_delay = {
	{(PropertyRNA *)&rna_PreferencesView_show_column_layout, (PropertyRNA *)&rna_PreferencesView_open_left_mouse_delay,
	-1, "open_right_mouse_delay", 3, 0, 0, 4, 0, "Hold RMB Open Toolbox Delay",
	"Time in 1/10 seconds to hold the Right Mouse Button before opening the toolbox",
	0, "*",
	PROP_INT, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(UserDef, tb_rightmouse), 1, NULL},
	PreferencesView_open_right_mouse_delay_get, PreferencesView_open_right_mouse_delay_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	1, 40, 1, 40, 1, 0, NULL
};

BoolPropertyRNA rna_PreferencesView_show_column_layout = {
	{(PropertyRNA *)&rna_PreferencesView_use_directional_menus, (PropertyRNA *)&rna_PreferencesView_open_right_mouse_delay,
...
BoolPropertyRNA rna_PreferencesView_use_directional_menus = {
	{(PropertyRNA *)&rna_PreferencesView_header_align_default, (PropertyRNA *)&rna_PreferencesView_show_column_layout,
...
static const EnumPropertyItem rna_PreferencesView_header_align_default_items[3] = {
	{0, "TOP", 0, "Top", ""},
	{128, "BOTTOM", 0, "Bottom", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_PreferencesView_header_align_default = {
	...
	-1, "header_align_default", 3, 0, 0, 0, 0, "Header Position",
	"Default header position for new space-types",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_userdef_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PreferencesView_header_align_default_get, PreferencesView_header_align_default_set, NULL, NULL, NULL, NULL, rna_PreferencesView_header_align_default_items, 2, 0
};
...
EnumPropertyRNA rna_PreferencesView_mini_axis_type = {
	{(PropertyRNA *)&rna_PreferencesView_mini_axis_size, (PropertyRNA *)&rna_PreferencesView_header_align_default,
...
static const EnumPropertyItem rna_PreferencesEdit_keyframe_new_interpolation_type_items[17] = {
	...
	{0, "CONSTANT", 1005, "Constant", "No interpolation, value of A gets held until B is encountered"},
	{1, "LINEAR", 1006, "Linear", "Straight-line interpolation between A and B (i.e. no ease in/out)"},
	{2, "BEZIER", 1007, "Bezier", "Smooth interpolation between A and B, with some control over curve shape"},
...
static const EnumPropertyItem rna_PreferencesEdit_keyframe_new_handle_type_items[6] = {
	{0, "FREE", 1583, "Free", "Completely independent manually set handle"},
	{3, "ALIGNED", 1584, "Aligned", "Manually set handle with rotation locked together with its pair"},
	{2, "VECTOR", 1585, "Vector", "Automatic handles that create straight lines"},
	{1, "AUTO", 1586, "Automatic", "Automatic handles that create smooth curves"},
	{4, "AUTO_CLAMPED", 1587, "Auto Clamped", "Automatic handles that create smooth curves which only change direction at keyframes"},
	{0, NULL, 0, NULL, NULL}
};
...
IntPropertyRNA rna_PreferencesInput_drag_threshold = {
	{(PropertyRNA *)&rna_PreferencesInput_tweak_threshold, (PropertyRNA *)&rna_PreferencesInput_walk_navigation,
...
IntPropertyRNA rna_PreferencesInput_tweak_threshold = {
	...
	-1, "tweak_threshold", 3, 0, 0, 4, 0, "Tweak Threshold",
	"Number of pixels you have to drag before tweak event is triggered",
	0, "*",
	PROP_INT, PROP_PIXEL | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	offsetof(UserDef, tweak_threshold), 1, NULL},
	PreferencesInput_tweak_threshold_get, PreferencesInput_tweak_threshold_set, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
	3, 1024, 3, 1024, 1, 0, NULL
};

FloatPropertyRNA rna_PreferencesInput_pressure_threshold_max = {
	{(PropertyRNA *)&rna_PreferencesInput_pressure_softness, (PropertyRNA *)&rna_PreferencesInput_tweak_threshold,
...
IntPropertyRNA rna_PreferencesFilePaths_auto_save_time = {
	{(PropertyRNA *)&rna_PreferencesFilePaths_use_keep_session, (PropertyRNA *)&rna_PreferencesFilePaths_use_auto_save_temporary_files,
...
BoolPropertyRNA rna_PreferencesFilePaths_use_keep_session = {
	{(PropertyRNA *)&rna_PreferencesFilePaths_recent_files, (PropertyRNA *)&rna_PreferencesFilePaths_auto_save_time,
	-1, "use_keep_session", 3, 0, 0, 0, 0, "Keep Session",
	"Always load session recovery and save it after quitting Blender",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PreferencesFilePaths_use_keep_session_get, PreferencesFilePaths_use_keep_session_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

IntPropertyRNA rna_PreferencesFilePaths_recent_files = {
	{(PropertyRNA *)&rna_PreferencesFilePaths_use_save_preview_images, (PropertyRNA *)&rna_PreferencesFilePaths_use_keep_session,
...
EnumPropertyRNA rna_PreferencesSystem_multi_sample = {
	{(PropertyRNA *)&rna_PreferencesSystem_gpencil_multi_sample, (PropertyRNA *)&rna_PreferencesSystem_scrollback,
...
EnumPropertyRNA rna_PreferencesSystem_gpencil_multi_sample = {
	{(PropertyRNA *)&rna_PreferencesSystem_use_region_overlap, (PropertyRNA *)&rna_PreferencesSystem_multi_sample,
...
FloatPropertyRNA rna_PreferencesSystem_light_ambient = {
	{(PropertyRNA *)&rna_PreferencesSystem_edit_studio_light, (PropertyRNA *)&rna_PreferencesSystem_solid_lights,
...
BoolPropertyRNA rna_PreferencesSystem_edit_studio_light = {
	...
	-1, "edit_studio_light", 3, 0, 0, 0, 0, "Edit Studio Light",
	"View the result of the studio light editor in the viewport",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_UserDef_viewport_lights_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	PreferencesSystem_edit_studio_light_get, PreferencesSystem_edit_studio_light_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

FloatPropertyRNA rna_PreferencesSystem_gl_clip_alpha = {
	{(PropertyRNA *)&rna_PreferencesSystem_image_draw_method, (PropertyRNA *)&rna_PreferencesSystem_edit_studio_light,
