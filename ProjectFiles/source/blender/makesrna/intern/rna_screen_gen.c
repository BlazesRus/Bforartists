...
StringPropertyRNA rna_Screen_layout_name;
...
BoolPropertyRNA rna_Area_show_editortypemenu;
BoolPropertyRNA rna_Area_file_toolbars;
BoolPropertyRNA rna_Area_meshedit_toolbars;
BoolPropertyRNA rna_Area_primitives_toolbars;
BoolPropertyRNA rna_Area_image_toolbars;
BoolPropertyRNA rna_Area_tools_toolbars;
BoolPropertyRNA rna_Area_animation_toolbars;
BoolPropertyRNA rna_Area_edit_toolbars;
BoolPropertyRNA rna_Area_misc_toolbars;
...
void Screen_layout_name_get(PointerRNA *ptr, char *value)
{
	rna_Screen_layout_name_get(ptr, value);
}

int Screen_layout_name_length(PointerRNA *ptr)
{
	return rna_Screen_layout_name_length(ptr);
}

void Screen_layout_name_set(PointerRNA *ptr, const char *value)
{
	rna_Screen_layout_name_set(ptr, value);
}
...
bool Area_show_editortypemenu_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 512) != 0);
}

void Area_show_editortypemenu_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_file_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 1024) != 0);
}

void Area_file_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_meshedit_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 2048) != 0);
}

void Area_meshedit_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_primitives_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 4096) != 0);
}

void Area_primitives_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_image_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 8192) != 0);
}

void Area_image_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_tools_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 16384) != 0);
}

void Area_tools_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_animation_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 32768) != 0);
}

void Area_animation_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_edit_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 65536) != 0);
}

void Area_edit_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
bool Area_misc_toolbars_get(PointerRNA *ptr)
{
	ScrArea *data = (ScrArea *)(ptr->data);
	return !(((data->flag) & 131072) != 0);
}

void Area_misc_toolbars_set(PointerRNA *ptr, bool value)
{
	ScrArea *data = (ScrArea *)(ptr->data);
...
StringPropertyRNA rna_Screen_layout_name = {
	...
	-1, "layout_name", 262145, 0, 0, 0, 0, "Layout Name",
	"The name of the layout that refers to the screen",
	0, "*",
	PROP_STRING, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Screen_layout_name_get, Screen_layout_name_length, Screen_layout_name_set, NULL, NULL, NULL, 0, ""
};

CollectionPropertyRNA rna_Screen_areas = {
	{(PropertyRNA *)&rna_Screen_is_animation_playing, (PropertyRNA *)&rna_Screen_layout_name,
...
StructRNA RNA_Screen = {
	...
	NULL,
	{(PropertyRNA *)&rna_Screen_layout_name, (PropertyRNA *)&rna_Screen_use_play_clip_editors}},
	"Screen", NULL, NULL, 519, NULL, "Screen",
	"Screen data-block, defining the layout of areas in a window",
	"*", 698,
	(PropertyRNA *)&rna_Screen_layout_name, (PropertyRNA *)&rna_ID_rna_properties,
	&RNA_ID,
	NULL,
	rna_ID_refine,
	NULL,
...
BoolPropertyRNA rna_Area_show_menus = {
	{(PropertyRNA *)&rna_Area_show_editortypemenu, (PropertyRNA *)&rna_Area_regions,
...
BoolPropertyRNA rna_Area_show_editortypemenu = {
	{(PropertyRNA *)&rna_Area_file_toolbars, (PropertyRNA *)&rna_Area_show_menus,
	-1, "show_editortypemenu", 3, 0, 0, 0, 0, "Show Editortype menu",
	"Shows or hides the Editortype menu to change the editor type",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_show_editortypemenu_get, Area_show_editortypemenu_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_file_toolbars = {
	{(PropertyRNA *)&rna_Area_meshedit_toolbars, (PropertyRNA *)&rna_Area_show_editortypemenu,
	-1, "file_toolbars", 3, 0, 0, 0, 0, "File Toolbars",
	"Shows or hides the File Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_file_toolbars_get, Area_file_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_meshedit_toolbars = {
	{(PropertyRNA *)&rna_Area_primitives_toolbars, (PropertyRNA *)&rna_Area_file_toolbars,
	-1, "meshedit_toolbars", 3, 0, 0, 0, 0, "Mesh Edit Toolbars",
	"Shows or hides the Mesh Edit Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_meshedit_toolbars_get, Area_meshedit_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_primitives_toolbars = {
	{(PropertyRNA *)&rna_Area_image_toolbars, (PropertyRNA *)&rna_Area_meshedit_toolbars,
	-1, "primitives_toolbars", 3, 0, 0, 0, 0, "Primitives Toolbars",
	"Shows or hides the Primitives Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_primitives_toolbars_get, Area_primitives_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_image_toolbars = {
	{(PropertyRNA *)&rna_Area_tools_toolbars, (PropertyRNA *)&rna_Area_primitives_toolbars,
	-1, "image_toolbars", 3, 0, 0, 0, 0, "Image Toolbars",
	"Shows or hides the Image Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_image_toolbars_get, Area_image_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_tools_toolbars = {
	{(PropertyRNA *)&rna_Area_animation_toolbars, (PropertyRNA *)&rna_Area_image_toolbars,
	-1, "tools_toolbars", 3, 0, 0, 0, 0, "Tools Toolbars",
	"Shows or hides the Tools Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_tools_toolbars_get, Area_tools_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_animation_toolbars = {
	{(PropertyRNA *)&rna_Area_edit_toolbars, (PropertyRNA *)&rna_Area_tools_toolbars,
	-1, "animation_toolbars", 3, 0, 0, 0, 0, "Animation Toolbars",
	"Shows or hides the Animation Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_animation_toolbars_get, Area_animation_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_edit_toolbars = {
	{(PropertyRNA *)&rna_Area_misc_toolbars, (PropertyRNA *)&rna_Area_animation_toolbars,
	-1, "edit_toolbars", 3, 0, 0, 0, 0, "Edit Toolbars",
	"Shows or hides the Edit Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_edit_toolbars_get, Area_edit_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

BoolPropertyRNA rna_Area_misc_toolbars = {
	{(PropertyRNA *)&rna_Area_type, (PropertyRNA *)&rna_Area_edit_toolbars,
	-1, "misc_toolbars", 3, 0, 0, 0, 0, "Misc Toolbars",
	"Shows or hides the Misc Toolbars",
	0, "*",
	PROP_BOOLEAN, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Area_misc_toolbars_get, Area_misc_toolbars_set, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL
};

static const EnumPropertyItem rna_Area_type_items[24] = {
	{0, "EMPTY", 0, "Empty", ""},
	{0, "", 0, "General", ""},
...
EnumPropertyRNA rna_Area_type = {
	{(PropertyRNA *)&rna_Area_ui_type, (PropertyRNA *)&rna_Area_misc_toolbars,
...
static const EnumPropertyItem rna_Area_ui_type_items[2] = {
	{0, "DEFAULT", 0, "Default", ""},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_Area_ui_type = {
	...
	0, -1, NULL},
	Area_ui_type_get, Area_ui_type_set, rna_Area_ui_type_itemf, NULL, NULL, NULL, rna_Area_ui_type_items, 1, 0
};
...
static const EnumPropertyItem rna_Region_type_items[11] = {
	{0, "WINDOW", 0, "Window", ""},
	{1, "HEADER", 0, "Header", ""},
...
EnumPropertyRNA rna_Region_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Region_type_get, NULL, NULL, NULL, NULL, NULL, rna_Region_type_items, 10, 0
};
