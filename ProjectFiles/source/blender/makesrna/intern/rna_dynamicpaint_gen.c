...
static const EnumPropertyItem rna_DynamicPaintBrushSettings_paint_source_items[6] = {
	{3, "PARTICLE_SYSTEM", 160, "Particle System", ""},
	{4, "POINT", 790, "Object Center", ""},
	{1, "DISTANCE", 747, "Proximity", ""},
	{2, "VOLUME_DISTANCE", 571, "Mesh Volume + Proximity", ""},
	{0, "VOLUME", 551, "Mesh Volume", ""},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_DynamicPaintBrushSettings_proximity_falloff_items[4] = {
	{1, "SMOOTH", 1063, "Smooth", ""},
	{0, "CONSTANT", 1067, "Constant", ""},
	{2, "RAMP", 102, "Color Ramp", ""},
	{0, NULL, 0, NULL, NULL}
};
...
IntPropertyRNA rna_DynamicPaintSurface_dry_speed = {
	...
	-1, "dry_speed", 3, 0, 0, 4, 0, "Dry Speed",
...
static const EnumPropertyItem rna_DynamicPaintSurface_init_color_type_items[5] = {
	{0, "NONE", 0, "None", ""},
	{1, "COLOR", 102, "Color", ""},
	{2, "TEXTURE", 152, "UV Texture", ""},
	{3, "VERTEX_COLOR", 370, "Vertex Color", ""},
	{0, NULL, 0, NULL, NULL}
};
