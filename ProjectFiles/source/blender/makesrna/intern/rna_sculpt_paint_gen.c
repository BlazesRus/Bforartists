...
static const EnumPropertyItem rna_ParticleEdit_select_mode_items[4] = {
	{1, "PATH", 1075, "Path", "Path edit mode"},
	{2, "POINT", 1073, "Point", "Point select mode"},
	{4, "TIP", 1074, "Tip", "Tip select mode"},
	{0, NULL, 0, NULL, NULL}
};
...
BoolPropertyRNA rna_ParticleEdit_show_particles = {
	...
	-1, "show_particles", 4194305, 0, 0, 0, 0, "Draw Particles",
...
static const EnumPropertyItem rna_GPencilSculptSettings_sculpt_tool_items[10] = {
	{0, "SMOOTH", 1556, "Smooth", "Smooth stroke points"},
	{1, "THICKNESS", 1557, "Thickness", "Adjust thickness of strokes"},
	{2, "STRENGTH", 1558, "Strength", "Adjust color strength of strokes"},
	{7, "RANDOMIZE", 1563, "Randomize", "Introduce jitter/randomness into strokes"},
	{3, "GRAB", 1559, "Grab", "Translate the set of points initially within the brush circle"},
	{4, "PUSH", 1560, "Push", "Move points out of the way, as if combing them"},
	{5, "TWIST", 1561, "Twist", "Rotate points around the midpoint of the brush"},
	{6, "PINCH", 1562, "Pinch", "Pull points towards the midpoint of the brush"},
	{8, "CLONE", 1564, "Clone", "Paste copies of the strokes stored on the clipboard"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_GPencilSculptSettings_weight_tool_items[2] = {
	{11, "WEIGHT", 1565, "Weight", "Weight Paint for Vertex Groups"},
	{0, NULL, 0, NULL, NULL}
};
...
static const EnumPropertyItem rna_GPencilSculptSettings_lock_axis_items[5] = {
	{0, "VIEW", 470, "View", "Align strokes to current view plane"},
	{2, "AXIS_Y", 1213, "Front (X-Z)", "Project strokes to plane locked to Y"},
	{1, "AXIS_X", 1212, "Side (Y-Z)", "Project strokes to plane locked to X"},
	{3, "AXIS_Z", 1214, "Top (X-Y)", "Project strokes to plane locked to Z"},
	{0, NULL, 0, NULL, NULL}
};
...
EnumPropertyRNA rna_GPencilSculptSettings_lock_axis = {
	...
	0, -1, NULL},
	GPencilSculptSettings_lock_axis_get, GPencilSculptSettings_lock_axis_set, NULL, NULL, NULL, NULL, rna_GPencilSculptSettings_lock_axis_items, 4, 0
};
...
static const EnumPropertyItem rna_GPencilSculptBrush_direction_items[3] = {
	...
	{1, "SUBTRACT", 544, "Subtract", "Subtract effect of brush"},
	{0, NULL, 0, NULL, NULL}
};
