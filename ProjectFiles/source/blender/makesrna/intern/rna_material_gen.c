...
EnumPropertyRNA rna_Material_transparent_shadow_method;
...
int Material_transparent_shadow_method_get(PointerRNA *ptr)
{
	Material *data = (Material *)(ptr->data);
	return (int)(data->blend_shadow);
}

void Material_transparent_shadow_method_set(PointerRNA *ptr, int value)
{
	Material *data = (Material *)(ptr->data);
...
EnumPropertyRNA rna_Material_blend_method = {
	{(PropertyRNA *)&rna_Material_transparent_shadow_method, NULL,
...
static const EnumPropertyItem rna_Material_transparent_shadow_method_items[5] = {
	{0, "NONE", 0, "None", "Material will cast no shadow"},
	{1, "OPAQUE", 0, "Opaque", "Material will cast shadows without transparency"},
	{2, "CLIP", 0, "Clip", "Use the alpha threshold to clip the visibility (binary visibility)"},
	{3, "HASHED", 0, "Hashed", "Use noise to dither the binary visibility and use filtering to reduce the noise"},
	{0, NULL, 0, NULL, NULL}
};

EnumPropertyRNA rna_Material_transparent_shadow_method = {
	{(PropertyRNA *)&rna_Material_alpha_threshold, (PropertyRNA *)&rna_Material_blend_method,
	-1, "transparent_shadow_method", 3, 0, 0, 0, 0, "Transparent Shadow",
	"Shadow method for transparent material",
	0, "*",
	PROP_ENUM, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
	rna_Material_draw_update, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	Material_transparent_shadow_method_get, Material_transparent_shadow_method_set, NULL, NULL, NULL, NULL, rna_Material_transparent_shadow_method_items, 4, 0
};

FloatPropertyRNA rna_Material_alpha_threshold = {
	{(PropertyRNA *)&rna_Material_show_transparent_back, (PropertyRNA *)&rna_Material_transparent_shadow_method,
...
static const EnumPropertyItem rna_Material_preview_render_type_items[7] = {
	{0, "FLAT", 1400, "Flat", "Flat XY plane"},
	{1, "SPHERE", 1401, "Sphere", "Sphere"},
	{2, "CUBE", 1402, "Cube", "Cube"},
	{3, "MONKEY", 1403, "Monkey", "Monkey"},
	{10, "HAIR", 1404, "Hair", "Hair strands"},
	{4, "SPHERE_A", 1407, "World Sphere", "Large sphere with sky"},
	{0, NULL, 0, NULL, NULL}
};
