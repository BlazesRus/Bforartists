...
struct PointerRNA UVLoopLayers_new(struct Mesh *_self, const char * name)
{
	return rna_Mesh_uv_layers_new(_self, name);
}
...
void UVLoopLayers_new_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	layer = rna_Mesh_uv_layers_new(_self, name);
...
struct PointerRNA rna_Mesh_uv_layers_new(struct Mesh *_self, const char * name);
...
StringPropertyRNA rna_UVLoopLayers_new_name = {
	{(PropertyRNA *)&rna_UVLoopLayers_new_layer, NULL,
...
PointerPropertyRNA rna_UVLoopLayers_new_layer = {
	{NULL, (PropertyRNA *)&rna_UVLoopLayers_new_name,
