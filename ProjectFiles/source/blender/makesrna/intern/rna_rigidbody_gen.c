...
static const EnumPropertyItem rna_RigidBodyObject_collision_shape_items[8] = {
	{0, "BOX", 551, "Box", "Box-like shapes (i.e. cubes), including planes (i.e. ground planes)"},
	{1, "SPHERE", 553, "Sphere", ""},
	{2, "CAPSULE", 560, "Capsule", ""},
	{3, "CYLINDER", 557, "Cylinder", ""},
	{4, "CONE", 559, "Cone", ""},
	{5, "CONVEX_HULL", 554, "Convex Hull", "A mesh-like surface encompassing (i.e. shrinkwrap over) all vertices (best results with fewer vertices)"},
	{6, "MESH", 556, "Mesh", "Mesh consisting of triangles only, allowing for more detailed interactions than convex hulls"},
	{0, NULL, 0, NULL, NULL}
};
