...
StringPropertyRNA rna_WorkspaceTool_name;
...
extern StringPropertyRNA rna_WorkspaceTool_setup_name;
...
void WorkspaceTool_name_get(PointerRNA *ptr, char *value)
{
	bToolRef *data = (bToolRef *)(ptr->data);
	BLI_strncpy_utf8(value, data->idname, 64);
}

int WorkspaceTool_name_length(PointerRNA *ptr)
{
	bToolRef *data = (bToolRef *)(ptr->data);
	return strlen(data->idname);
}

void WorkspaceTool_name_set(PointerRNA *ptr, const char *value)
{
	bToolRef *data = (bToolRef *)(ptr->data);
...
{
	extern int Screen_layout_name_length(PointerRNA *);
	extern void Screen_layout_name_get(PointerRNA *, char *);
	...
	while (iter.valid) {
		if (iter.ptr.data) {
			int namelen = Screen_layout_name_length(&iter.ptr);
			if (namelen < 1024) {
				Screen_layout_name_get(&iter.ptr, namebuf);
				...
				Screen_layout_name_get(&iter.ptr, name);
...
{
	extern int WorkspaceTool_name_length(PointerRNA *);
	extern void WorkspaceTool_name_get(PointerRNA *, char *);
	...
	while (iter.valid) {
		if (iter.ptr.data) {
			int namelen = WorkspaceTool_name_length(&iter.ptr);
			if (namelen < 1024) {
				WorkspaceTool_name_get(&iter.ptr, namebuf);
				if (strcmp(namebuf, key) == 0) {
					found = true;
					*r_ptr = iter.ptr;
					break;
				...
				name = MEM_mallocN(namelen+1, "name string");
				WorkspaceTool_name_get(&iter.ptr, name);
				if (strcmp(name, key) == 0) {
					MEM_freeN(name);
...
void WorkspaceTool_setup(struct ID *_selfid, struct bToolRef *_self, bContext *C, const char * name, int cursor, const char * keymap, const char * gizmo_group, const char * data_block, const char * operator_value, int index)
{
	rna_WorkspaceTool_setup(_selfid, _self, C, name, cursor, keymap, gizmo_group, data_block, operator_value, index);
}
...
void WorkspaceTool_setup_call(bContext *C, ReportList *reports, PointerRNA *_ptr, ParameterList *_parms)
{
	...
	rna_WorkspaceTool_setup(_selfid, _self, C, name, cursor, keymap, gizmo_group, data_block, operator, index);
}
...
void rna_WorkspaceTool_setup(struct ID *_selfid, struct bToolRef *_self, bContext *C, const char * name, int cursor, const char * keymap, const char * gizmo_group, const char * data_block, const char * operator_value, int index);
...
PointerPropertyRNA rna_WorkspaceTool_rna_type = {
	{(PropertyRNA *)&rna_WorkspaceTool_name, (PropertyRNA *)&rna_WorkspaceTool_rna_properties,
	-1, "rna_type", 8912896, 0, 0, 0, 0, "RNA",
	"RNA type definition",
	0, "*",
	PROP_POINTER, PROP_NONE | PROP_UNIT_NONE, NULL, 0, {0, 0, 0}, 0,
...
StringPropertyRNA rna_WorkspaceTool_name = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WorkspaceTool_name_get, WorkspaceTool_name_length, WorkspaceTool_name_set, NULL, NULL, NULL, 64, ""
};

IntPropertyRNA rna_WorkspaceTool_index = {
	{(PropertyRNA *)&rna_WorkspaceTool_space_type, (PropertyRNA *)&rna_WorkspaceTool_name,
...
static const EnumPropertyItem rna_WorkspaceTool_space_type_items[24] = {
	{0, "EMPTY", 0, "Empty", ""},
	{0, "", 0, "General", ""},
...
EnumPropertyRNA rna_WorkspaceTool_space_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WorkspaceTool_space_type_get, NULL, NULL, NULL, NULL, NULL, rna_WorkspaceTool_space_type_items, 23, 0
};
...
StringPropertyRNA rna_WorkspaceTool_setup_name = {
...
EnumPropertyRNA rna_WorkspaceTool_setup_cursor = {
	{(PropertyRNA *)&rna_WorkspaceTool_setup_keymap, (PropertyRNA *)&rna_WorkspaceTool_setup_name,
...
FunctionRNA rna_WorkspaceTool_setup_func = {
	...
	NULL,
	{(PropertyRNA *)&rna_WorkspaceTool_setup_name, (PropertyRNA *)&rna_WorkspaceTool_setup_index}},
...
static const EnumPropertyItem rna_WorkSpace_tools_space_type_items[24] = {
	{0, "EMPTY", 0, "Empty", ""},
	{0, "", 0, "General", ""},
	{1, "VIEW_3D", 200, "3D Viewport", "Manipulate objects in a 3D environment"},
	{6, "IMAGE_EDITOR", 294, "UV/Image Editor", "View and edit images and UV Maps"},
...
EnumPropertyRNA rna_WorkSpace_tools_space_type = {
	...
	NULL, 0, NULL, NULL, rna_property_override_diff_default, rna_property_override_store_default, rna_property_override_apply_default,
	0, -1, NULL},
	WorkSpace_tools_space_type_get, NULL, NULL, NULL, NULL, NULL, rna_WorkSpace_tools_space_type_items, 23, 0
};
...
static const EnumPropertyItem rna_WorkSpace_object_mode_items[13] = {
	...
	{128, "EDIT_GPENCIL", 251, "Grease Pencil Edit Mode", "Edit Grease Pencil Strokes"},
	{512, "SCULPT_GPENCIL", 256, "Grease Pencil Sculpt Mode", "Sculpt Grease Pencil Strokes"},
	{256, "PAINT_GPENCIL", 365, "Grease Pencil Draw", "Paint Grease Pencil Strokes"},
	{1024, "WEIGHT_GPENCIL", 255, "Grease Pencil Weight Paint", "Grease Pencil Weight Paint Strokes"},
	{0, NULL, 0, NULL, NULL}
};
