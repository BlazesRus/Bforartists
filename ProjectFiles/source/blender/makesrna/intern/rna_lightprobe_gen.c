...
static const EnumPropertyItem rna_LightProbe_type_items[4] = {
	{0, "CUBEMAP", 345, "Reflection Cubemap", "Capture reflections"},
	{1, "PLANAR", 347, "Reflection Plane", ""},
	{2, "GRID", 346, "Irradiance Volume", "Volume used for precomputing indirect lighting"},
	{0, NULL, 0, NULL, NULL}
};
